...
selected_tab = st.sidebar.radio("Choose an Option", ["Portfolio Analysis", "Technical Analysis Dashboard", "ML MODEL", "Financial News", "Learn Technalities"])
...
elif selected_tab == "Technical Analysis Dashboard":
...
elif selected_tab == "Financial News":
...
elif selected_tab == "Learn Technalities":
